...
<head>
  ...
  <title>Dashboard Administration RPL</title>
  ...
  <div class="content-wrapper">
	...
	<div class="content">
     <div class="panel panel-info">
		...
		<h2><b>Hak Akses Administrator</b></h2>
		<ul class="fa-ul">
			<li><h3><i class="fa-li fa fa-code"></i>Olah Data Provinsi</h3></li>
			<li><h3><i class="fa-li fa fa-code"></i>Olah Data Kota</h3></li>
			<li><h3><i class="fa-li fa fa-code"></i>Olah Data Cabang Olahraga</h3></li>
			<li><h3><i class="fa-li fa fa-code"></i>Olah Data Operator</h3></li>
