  ...
  <div class="content-wrapper">
	...
	<div class="panel panel-warning">
	  ...
	  <div class="panel-body">
        ...
        <h1 align=center>Data Jenis Sarana &amp Prasarana  <i class="fa  fa-clone " style="color:#fceecc"></i></h1>
        <br />
        <button class="btn btn-success" onclick="add_jenis()"><i class="glyphicon glyphicon-plus"></i>Tambah Jenis Sarana &amp Prasarana</button>
        ...
        <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    <th>ID Jenis Sarana &amp Prasarana</th>
                    <th>Nama Jenis Sarana &amp Prasarana</th>
	...
	$(document).ready(function() {
		...
		table = $('#table').DataTable({ 
			...
			"ajax": {
				"url": "<?php echo site_url('master/jenis/ajax_list')?>", <!-- ini nih masalah ri DataTable ini tadi bi yg bikin error pas di console, not found nih urlnya
				"type": "POST"
			},
	...
	function add_jenis()
	{
		...
		$('.modal-title').text('Add Jenis Sarana &amp Prasarana'); // Set Title to Bootstrap modal title
	}
	...
	function edit_jenis(id)
	{
		...
		$.ajax({
			url : "<?php echo site_url('master/jenis/ajax_edit/')?>/" +id,
			type: "GET",
			dataType: "JSON",
			success: function(data)
			{

				$('[name="jenis_id"]').val(data.jenis_id);
				$('[name="jenis"]').val(data.jenis);
				$('#modal_form').modal('show'); // show bootstrap modal when complete loaded
				$('.modal-title').text('Edit Jenis Sarana &amp Prasarana'); // Set title to Bootstrap modal title
	...
	function save()
	{
		...
		if(save_method == 'add') {
			url = "<?php echo site_url('master/jenis/ajax_add')?>";
		} else {
			url = "<?php echo site_url('master/jenis/ajax_update')?>";
		}
	...
	function delete_jenis(id)
	{
		if(confirm('Are you sure delete this data?'))
		{
			...
			$.ajax({
				url : "<?php echo site_url('master/jenis/ajax_delete')?>/"+id,
				type: "POST",
				dataType: "JSON",
				success: function(data)
				{
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 class="modal-title">Insert Jenis Sarana &amp Prasarana</h3>
				</div>
				<div class="modal-body form">
					<form action="#" id="form" class="form-horizontal">
						...
						<div class="form-body">
									...
									<input name="jenis_id" class="form-control" type="hidden">
								   
							<div class="form-group">
								<label class="control-label col-md-3">Nama Jenis</label>
								<div class="col-md-9">
									<input name="jenis" placeholder="Nama Jenis Sarana &amp Prasarana" class="form-control" type="text">
