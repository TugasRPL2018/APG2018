  ...
  <div class="content-wrapper">
	...
	<div class="panel panel-success">
	  ...
	  <div class="panel-body">
        ...
        <h1 align=center>Data Provinsi  <i class="fa fa-map" style="color:green"></i></h1>
        <br />
        <button class="btn btn-success" onclick="add_provinsi()"><i class="glyphicon glyphicon-plus"></i>Tambah Provinsi</button>
	...
	$(document).ready(function() {
		...
		table = $('#table').DataTable({ 
			...
			"ajax": {
				"url": "<?php echo site_url('master/provinsi/ajax_list')?>", <!-- ini nih masalah ri DataTable ini tadi bi yg bikin error pas di console, not found nih urlnya
				"type": "POST"
			},
	...
	function edit_provinsi(id)
	{
		...
		$.ajax({
			url : "<?php echo site_url('master/provinsi/ajax_edit/')?>/" +id,
			type: "GET",
			dataType: "JSON",
	...
	function save()
	{
		...
		var url;
		if(save_method == 'add') {
			url = "<?php echo site_url('master/provinsi/ajax_add')?>";
		} else {
			url = "<?php echo site_url('master/provinsi/ajax_update')?>";
		}
	...
	function delete_provinsi(id)
	{
		if(confirm('Are you sure delete this data?'))
		{
			...
			$.ajax({
				url : "<?php echo site_url('master/provinsi/ajax_delete')?>/"+id,
				type: "POST",
				dataType: "JSON",
				success: function(data)
				{
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 class="modal-title">Insert Provinsi</h3>
				</div>
				<div class="modal-body form">
					<form action="#" id="form" class="form-horizontal">
						...
						<div class="form-body">
									...
									<input name="provinsi_id" class="form-control" type="hidden">
								   
							<div class="form-group">
								<label class="control-label col-md-3">Nama Provinsi</label>
								<div class="col-md-9">
									<input name="provinsi" placeholder="Nama Provinsi"  type="text" class="form-control">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input name="lat" placeholder="Latitude" class="form-control" type="text" required>
									<span class="help-block"></span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-9">
									<input name="lng" placeholder="Longitude" class="form-control" type="text" required>
									<span class="help-block"></span>
								</div>
							</div>
						</div>
