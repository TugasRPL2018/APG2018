  ...
  <div class="content-wrapper">
	...
	<div class="panel panel-danger">
	  ...
	  <div class="panel-body">
        <h1 align=center>Data Account Anda  <i class="fa fa-user" style="color:pink"></i></h1>
        <br />
        <br />
        <br />
	...
	$(document).ready(function() {
		...
		table = $('#table').DataTable({ 
			...
			"ajax": {
				"url": "<?php echo site_url('master/ubahpassword/ajax_list')?>",
				"type": "POST"
			},
	...
	function edit_ubahpassword(id)
	{
		...
		$.ajax({
			url : "<?php echo site_url('master/ubahpassword/ajax_edit/')?>/" +id,
			type: "GET",
			dataType: "JSON",
	...
	function save()
	{
		...
		var url;
		if(save_method == 'add') {
			url = "<?php echo site_url('master/ubahpassword/ajax_add')?>";
		} else {
			url = "<?php echo site_url('master/ubahpassword/ajax_update')?>";
		}
					...
					<form action="#" id="form" class="form-horizontal">
						...
						<div class="form-body">								   
							<div class="form-group">
								...
								<div class="col-md-9">
									<input name="username" placeholder="Nama Jenis Sarana &amp Prasarana" class="form-control" type="text">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input name="password" placeholder="Nama Jenis Sarana &amp Prasarana" class="form-control" type="password">
									<span class="help-block"></span>
								</div>
							</div>
						<input name="level" class="form-control" type="hidden">
						</div>
					</form>
				</div>
