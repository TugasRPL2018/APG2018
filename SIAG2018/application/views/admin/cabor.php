  ...
  <div class="content-wrapper">
	...
	<div class="panel panel-success">
	  ...
	  <div class="panel-body">
        ...
        <h1 align=center>Data Cabang Olahraga  <i class="fa fa-soccer-ball-o " style="color:green"></i></h1>
        <br />
        <button class="btn btn-success" onclick="add_cabor()"><i class="glyphicon glyphicon-plus"></i>Tambah Cabang Olahraga</button>
	...
	$(document).ready(function() {
		...
		table = $('#table').DataTable({ 
			...
			"ajax": {
				"url": "<?php echo site_url('master/cabor/ajax_list')?>", <!-- ini nih masalah ri DataTable ini tadi bi yg bikin error pas di console, not found nih urlnya
				"type": "POST"
			},
	...
	function add_cabor()
	{
		...
		$('.modal-title').text('Add Cabang Olahraga'); // Set Title to Bootstrap modal title
	}

	function edit_cabor(id)
	{
		save_method = 'update';
		$('#form')[0].reset(); // reset form on modals
		$('.form-group').removeClass('has-error'); // clear error class
		...
		$.ajax({
			url : "<?php echo site_url('master/cabor/ajax_edit/')?>/" +id,
			type: "GET",
			dataType: "JSON",
			success: function(data)
			{

				$('[name="cabor_id"]').val(data.cabor_id);
				$('[name="cabor"]').val(data.cabor);
				$('#modal_form').modal('show'); // show bootstrap modal when complete loaded
				$('.modal-title').text('Edit Cabang Olahraga'); // Set title to Bootstrap modal title
	...
	function save()
	{
		...
		if(save_method == 'add') {
			...
			url = "<?php echo site_url('master/cabor/ajax_add')?>";
		} else {
			url = "<?php echo site_url('master/cabor/ajax_update')?>";
		}
	...
	function delete_cabor(id)
	{
		if(confirm('Are you sure delete this data?'))
		{
			// ajax delete data to database
			$.ajax({
				url : "<?php echo site_url('master/cabor/ajax_delete')?>/"+id,
				type: "POST",
				dataType: "JSON",
				success: function(data)
				{
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 class="modal-title">Insert Cabang Olahraga</h3>
				</div>
				<div class="modal-body form">
					...
					<?php echo validation_errors(); ?>
						...
						<div class="form-body">
									...
									<input name="cabor_id" class="form-control" type="hidden">
								   
							<div class="form-group">
								<label class="control-label col-md-3">Nama cabor</label>
								<div class="col-md-9">
									<input name="cabor" placeholder="Nama cabor" class="form-control" type="text">
