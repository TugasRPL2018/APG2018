...
<section class="navbar navbar-default navbar-fixed-top" role="navigation">
	<div class="container">
		<div class="navbar-header">
			...
			<a href="#" class="navbar-brand">ENAM</a>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-4 wow fadeInUp" data-wow-delay="0.6s">
				...
				<ul class="social-icon">
					...
					<li><a href="#" target="_blank" class="fa fa-twitter wow bounceIn" data-wow-delay="0.6s"></a></li>
					<li><a href="#" target="_blank" class="fa fa-behance wow bounceIn" data-wow-delay="0.9s"></a></li>
					<li><a href="#" target="_blank" class="fa fa-dribbble wow bounceIn" data-wow-delay="0.9s"></a></li>
